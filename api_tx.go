...
/*
 * TxBroadcastBatchPost Broadcast a batch of tx to MvcApi fullnode. This endpoint use rpc sendrawtransactions.
...
/*
 * TxBroadcastPost Broadcast tx to MvcApi fullnode.
...
/*
 * TxTxidSeenGet Whether MvcApi have seen this tx before. This is a fast approach to know if the tx exist or not.
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param txid the request ID to search, txhash
